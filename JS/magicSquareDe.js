...
document.getElementById('encryption-form').addEventListener('submit', function(event) {
    ...
    const encryptedMessage = magicSquareDecryption(magicSquare, message);
...
document.getElementById('encryption-form').addEventListener('submit', function (event) {
    ...
    const encryptedText = magicSquareDecryption(magicSquare, inputText);
...
function magicSquareDecryption(square, message) {
